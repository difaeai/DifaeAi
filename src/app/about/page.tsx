      ...
      <main className="flex-1">
        ...
        <PageSection>
          <FadeIn className="mx-auto max-w-3xl space-y-6 text-center">
            ...
            <p className="text-base text-muted-foreground" dangerouslySetInnerHTML={{ __html: content?.story?.p1 ?? "Started in 2019, BERRETO Pvt Ltd. established itself as a leading development and design partner for ambitious organisations across the world." }} />
        ...
        <PageSection background="muted">
          <FadeIn className="space-y-10">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-primary">Mission & Vision</p>
        ...
        <PageSection>
          <FadeIn className="space-y-12">
            <div className="max-w-2xl">
              <p className="text-xs font-semibold uppercase tracking-[0.28em] text-primary">Our Values</p>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {values.map((value) => (
                <div key={value.title} className="rounded-3xl border border-border/60 bg-white/80 p-6 text-center shadow-lg shadow-primary/10">
                  ...
                  <h4 className="mt-6 font-headline text-xl font-semibold text-foreground">{value.title}</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-6 sm:grid-cols-2">
                <div className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-lg shadow-primary/10">
                  ...
                  <p className="mt-4 text-sm font-semibold uppercase tracking-[0.24em] text-primary">Operational footprint</p>
                  <p className="mt-2 text-lg text-foreground">Monitoring 5+ countries with regional partners</p>
                </div>
                <div className="rounded-3xl border border-border/60 bg-white/80 p-6 shadow-lg shadow-primary/10">
                  <Users className="h-8 w-8 text-primary" />
                  <p className="mt-4 text-sm font-semibold uppercase tracking-[0.24em] text-primary">Security experts</p>
                  <p className="mt-2 text-lg text-foreground">Certified analysts and architects on-call 24/7</p>
                </div>
              </div>
            </div>
            <div className="space-y-6 rounded-3xl border border-border/60 bg-white/80 p-8 shadow-xl shadow-primary/10">
              <h3 className="font-headline text-2xl font-semibold text-foreground">Join us</h3>
              <p className="text-sm text-muted-foreground">
